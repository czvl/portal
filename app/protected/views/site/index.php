        ...
        <section id="contact" class="single-page scrollblock">
            <div class="container">
                ...
                <div class="row">
                    <div class="span12">
                        <h2 style="color: #f0bf00">Київ</h2>
                        <h2>Працевлаштування переселенців</h2>
                        ...
                        <h2>Працевлаштування ветеранів АТО, проект “Воїну-гідна праця”</h2>
                        <p>
                        ...
                        <h2>Навчання підприємництву, проект “BizClub”</h2>
                        <p>
                            координатор Віра Лебедєва, +380 (66) 905-62-34, office.bizclub@gmail.com
                        </p>

                        <h2>Працевлаштування людей з інвалідністю</h2>
                        <p>
                            координатор Марина Лебідь, +380 (99) 609-93-45, czvl.inclusion@gmail.com
                        </p>

                        <h2> Працевлаштування людей старшого віку, проект “Дивовік”</h2>
