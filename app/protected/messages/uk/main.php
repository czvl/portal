...
return array(
    ...
    'user.email.confirm.body' => '<p>Вітаємо! Команда громадської організації "Центр зайнятості вільних людей" вдячна за Вашу участь і небайдужість до такої значущої соціальної проблеми як працевлаштування переселенців зі Сходу України та АРК Крим.</p>
<p>Для продовження роботи із порталом просимо Вас перейти за цим посиланням: :link</p><p></p>
<p>Додатково повідомляємо Вас, що на порталі громадської організації "Центр зайнятості вільних людей" інформація щодо відкритих вакансій зберігається 14 днів.</p>
<p>
Наші контакти:<br />
Сайт "ЦЗВЛ": http://czvl.org.ua<br />
Сторінка організації в мережі Facebook: www.facebook.com/czvl.staff
</p>
<p></p>
<p>За більш детальною інформацією просимо Вас звертатись за електронною адресою: czvl.job@gmail.com</p>',
