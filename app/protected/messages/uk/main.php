...
return array(
    ...
    'vacancy.label.categories' => 'Професійна сфера',
    'vacancy.label.educations' => 'Вкажіть вимоги до освітнього рівня кандидатів',
    'vacancy.label.positions' => 'Будь ласка, вкажіть посаду, назва якої співпадає (або є близькою) до Вашої',
