...
class CvToAssistance extends CActiveRecord
{
    ...
    {
        return array(
            'cv_assistance' => array(self::BELONGS_TO, 'CvList', 'cv_id'),
        );
    }
    ...
    public function getAssistanceById($userId)
    {
        $html = '';
        $assistanceTypes = $this->module->loadConfigFromFile('assistance_types');
