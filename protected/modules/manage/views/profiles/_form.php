        ...
        <div class="form"></div>
            ...
            <?php echo $form->dropDownListControlGroup($model, 'category_id', $model->getCategoriesTypes(), array('span' => 5)); ?>
            ...
            <?php echo $form->checkBoxListControlGroup($model, 'assistance_ids[]', $model->assistanceTypes); ?>
